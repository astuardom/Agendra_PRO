...
import { AppointmentStatus, Appointment, Patient } from '@/shared/types';
...
import { SERVICES, FIXED_TIMES, DASHBOARD_STORAGE_KEY } from '@/shared/constants';
        ...
        <div className="p-4 sm:p-6 lg:p-10 bg-[#f8fafc] overflow-y-auto flex-1 overflow-x-hidden">
          <div className="max-w-[1400px] mx-auto space-y-6 sm:space-y-8">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <TodayAppointments
                appointments={appointments.filter((a) => a.date === todayISO)}
              ...
              <RecentPatients
                patients={patients}
                limit={5}
                onViewAll={() => setActiveTab('patients')}
                onSelectPatient={(p) => { setActiveTab('patients'); openPatientEdit(p); }}
              />
            </div>
